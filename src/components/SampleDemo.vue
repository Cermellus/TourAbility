					...
					<div class="p-messages-wrapper">
						<ul>
							<li>
								...
								<span class="p-messages-detail">Babylon provides a theme for all 50+ PrimeVue Components. This page contains samples of the commonly used components for demo purposes.</span>
							</li>
						</ul>
					</div>
				</div>
	...
	data(){
		return {
			...
			menuItems: [
				...
				{
					label: 'Account',
					items: [{label: 'Option', icon: 'pi pi-fw pi-cog',command:() => window.location.hash="/"},
